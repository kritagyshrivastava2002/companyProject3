  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      ...
      <div className="flex justify-center mb-4">
        ...
        <h4 className="text-xl font-bold text-center text-black-700 mb-6">Get Started with Soft Webtechs Solutions</h4>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label htmlFor="email" className=" W-32 block text-gray-700 font-semibold mb-2">
              Email
            </label>
            <input
              type="email"
